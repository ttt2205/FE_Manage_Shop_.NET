...
import { Badge, Button, Card, Container, Form, Modal, Table, ButtonGroup, Spinner } from "react-bootstrap";
...
const Inventory = () => {
    ...
    const categories = ["Tất cả", "Đồ ăn", "Bánh kẹo", "Gia vị", "Đồ gia dụng", "Mỹ phẩm"];
    ...
    const filteredProducts = inventory.filter((item) => {
        ...
        const matchesCategory =
            ...
            (item.product.category && item.product.category.categoryName === categoryFilter);
    ...
    const handleExportPdf = () => {
        window.open(`${API_URL}/inventory/export-pdf`, '_blank');
    };
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <Badge bg="light" text="dark">
                                            {item.product?.category?.categoryName ?? "Chưa phân loại"}
                                        </Badge>
                                    </td>
            ...
            <Modal show={isAuditModalOpen} onHide={() => setIsAuditModalOpen(false)}>
                ...
                <Modal.Body>
                    ...
                    <p className="text-muted small">
                        Một phiên kiểm kê mới sẽ được tạo. Bạn có thể bắt đầu thêm các sản phẩm đã đếm
                        thực tế vào phiên này.
                    </p>
                </Modal.Body>
                <Modal.Footer>
